...
public class Util {
    ...
    public static final String AUTH_COOKIE_RAW = "authCookieRaw";
     ...
     */
    private static final String SHARED_PREFS = "bmxconnect".toUpperCase(Locale.ENGLISH) + "_PREFS";
     ...
     */
    public static void generateRegistrationNotification(Context context, String message) {
        generateNotificationMessage(context, "Registration Change", message);
    }

    /**
     * Display a notification containing the given string.
     */
    public static void generateResultNotification(Context context, String message, String datetime) {
    	generateNotificationMessage(context, "New Positive Result", message + ", " + datetime);
    }

	private static void generateNotificationMessage(Context context, String title, String message) {
		int icon = R.drawable.bmxconnect_status_icon;
        ...
        notification.defaults |= Notification.DEFAULT_SOUND;// | Notification.DEFAULT_VIBRATE; // why does this crash my app?!!
        ...
        editor.putInt("notificationID", ++notificatonID % 4); // up to 4 notification messages
        editor.commit();
	}
