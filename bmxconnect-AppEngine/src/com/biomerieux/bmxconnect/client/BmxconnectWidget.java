...
public class BmxconnectWidget extends Composite {
  ...
  interface BmxconnectUiBinder extends UiBinder<Widget, BmxconnectWidget> {
  }

  private static BmxconnectUiBinder uiBinder = GWT.create(BmxconnectUiBinder.class);
...
//      recipientArea.setValue("");
  ...
  public BmxconnectWidget() {
    initWidget(uiBinder.createAndBindUi(this));

	if (Window.Navigator.getPlatform().contains("Android")) {
		qrimage.setClassName(STATUS_NONE);
	}
...
//TODO: example of client/server comm via RF!!!
